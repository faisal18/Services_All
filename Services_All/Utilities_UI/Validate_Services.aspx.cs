    ...
    public partial class Valdiate_Services : System.Web.UI.Page
    {
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            if (rd_erx.Checked == true)
                ...
                service = "shafafiya";
            else if (rd_medical_service.Checked == true)
                service = "medical_member";
            else if (rd_DHCC.Checked == true)
                service = "DHCC";
        ...
        protected void rd_erx_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lbl_response.Text = null;
            rd_medical_service.Checked = false;
            rd_DHCC.Checked = false;
        ...
        protected void rd_medservice_member_CheckedChanged(object sender, EventArgs e)
        {
            rd_erx.Checked = false;
            rd_dhpo.Checked = false;
            rd_pbmswitch_dimensions.Checked = false;
            ...
            txt_richbox.InnerText = null;
            lbl_response.Text = null;
            rd_medical_service.Checked = true;
            rd_DHCC.Checked = false;

        }

        protected void rd_DHCC_CheckedChanged(object sender, EventArgs e)
        {
            rd_erx.Checked = false;
            rd_dhpo.Checked = false;
            rd_pbmswitch_dimensions.Checked = false;
