...
{
    public partial class JordanForm_Lab : System.Web.UI.Page
    {
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txt_rich_box.InnerText = ExtraClasses.JordanCS_LAB.upload_lab_request(data_array,input_richbox.InnerText);
            }
            catch (Exception ex)
            {
