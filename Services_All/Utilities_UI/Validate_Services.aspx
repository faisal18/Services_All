        ...
        <div>
            <asp:Table runat="server" ID="table_divs" CellPadding="5" CellSpacing="10">
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:RadioButton runat="server" ID="rd_medical_service" Text="Medical Member Service" AutoPostBack = "true" OnCheckedChanged="rd_medservice_member_CheckedChanged" />
                    </asp:TableCell>
                    <asp:TableCell>
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell>
                        <asp:RadioButton runat="server" ID="rd_DHCC" Text="DHCC"  AutoPostBack="true" OnCheckedChanged="rd_DHCC_CheckedChanged" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell>
